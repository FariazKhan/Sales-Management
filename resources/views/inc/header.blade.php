            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="label label-warning">{{ $out_of_stock }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="header"> <a href="{{ route('product.index') }}"><strong>{{ $out_of_stock }}</strong> products are currently out of stock.</a></li>
                    </ul>
                </li>
                <li class="dropdown notifications-menu">
